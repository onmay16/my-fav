...
function Profile() {
    ...
    function follow() {
        axios.get("http://ec2-54-81-90-22.compute-1.amazonaws.com/accounts/follow/"+nickname.nickname+"/")
    ...
    function unfollow() {
        axios.get("http://ec2-54-81-90-22.compute-1.amazonaws.com/accounts/unfollow/"+nickname.nickname+"/")
    ...
    useEffect(() => {
        ...
        axios.get("http://ec2-54-81-90-22.compute-1.amazonaws.com/accounts/profile/" + nickname.nickname + "/")
